 ...
 * ------------------------------------
 *
 * Manages the data directories for vpub-market.
 *
 *  Linux:
 *  OSX:
 *  Windows:
...
export class DataDir {
    ...
    public static initialize(env: EnvConfig): boolean {
        ...
        // may also be the vpub-market/testnet
    ...
    public static createDefaultEnvFile(): Promise<boolean> {
        return new Promise((resolve, reject) => {
            ...
            // /somepath/vpub-market/srcORdist/core/helpers -> /somepath/vpub-market/srcORdist/
