...
export class CurrencyPriceService {
     ...
     *
     * description: from argument must be VPUB for now and toCurrencies is an array of toCurrencies like [INR, USD, EUR, GBP].
     *
     * @param {string} fromCurrency name (VPUB for now)
     ...
     * fromCurrency: VPUB (must be VPUB for now)
