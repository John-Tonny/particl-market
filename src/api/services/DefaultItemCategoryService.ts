...
export class DefaultItemCategoryService {
    ...
    public async seedDefaultCategories(): Promise<void> {
        ...
        let LEVEL1CHILD = await this.insertOrUpdateCategory({ key: 'cat_particl', name: 'Vircle', description: '', parent_item_category_id: ROOT.Id } as ItemCategoryCreateRequest);
