    ...
    private async checkConnection(): Promise<boolean> {
        ...
        if (isConnected) {
            ...
            if (this.previousState !== isConnected) {
                this.log.info('connection with vircled established.');
            ...
            // this.log.info('connected to vircled, checking again in ' + this.interval + 'ms.');
        } else {

            if (this.previousState !== isConnected) {
                this.log.info('connection with vircled disconnected.');
            ...
            if (process.env.NODE_ENV !== 'test') {
                this.log.error('failed to connect to vircled, retrying in ' + this.interval + 'ms.');
            }
        }
